...
const AdminDashboard = () => {
    ...
    return (
        <div className="flex min-h-screen bg-zinc-950 text-white font-inter w-full">
            ...
            {/* Sidebar - This is now sticky on all relevant screen sizes */}
            <aside
                className={`
                    ...
                    /* The 'fixed' positioning combined with 'md:translate-x-0' ensures it's sticky */
                `}
            >
                <div className="p-4 text-center border-b border-zinc-700 mb-6">
                    ...
                    {/* Close button for mobile sidebar (hidden on md and larger) */}
                    <button
                        onClick={toggleSidebar}
            ...
            <main className="flex-1 p-4 sm:p-8 bg-zinc-950 overflow-y-auto">
                {/* Hamburger menu button for mobile (hidden on md and larger) */}
                <button
                    onClick={toggleSidebar}

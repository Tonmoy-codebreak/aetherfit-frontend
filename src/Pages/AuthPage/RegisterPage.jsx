...
const RegisterPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Success alert - MODIFIED TEXT AND ADDED FONT-FUNNEL TO TITLE
            Swal.fire({
                title: '<span class="font-funnel" style="color:#faba22">Account created successfully!</span>',
                text: "Welcome to AetherFit! You've joined as a Member.",
                icon: "success",
                background: "black",
                color: "#faba22",
                confirmButtonColor: "#faba22",
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            // Success alert - MODIFIED TEXT AND ADDED FONT-FUNNEL TO TITLE
            Swal.fire({
                title: '<span class="font-funnel" style="color:#faba22">Google Login Successful!</span>',
                text: "Welcome to AetherFit! You've joined as a member of the AetherFit family.",
                icon: "success",
                background: "black",
                color: "#faba22",
                confirmButtonColor: "#faba22",
